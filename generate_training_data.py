...
功能：调用大模型生成 Segmenter 和 Linker 训练数据
优化：直接让大模型输出带精确索引的 JSON，移除复杂的字符串匹配逻辑
"""
...
def extract_json(raw: str):
    """安全提取 JSON，自动去除 Markdown 代码块及前后杂质"""
